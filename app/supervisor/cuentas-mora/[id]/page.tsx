...
export default function DetalleCuentaMoraSupervisorPage({ params }: { params: { id: string } }) {
  const { id } = params
      ...
      <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-sm border-b border-slate-200">
        <div className="px-6 py-3 w-full mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/supervisor/clientes" className="p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors">
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Detalle por qué este caso requiere intervención de supervisión..."
                    ></textarea>
                  </div>
