          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-slate-900">
                <span className="text-blue-600">Editar</span> <span className="text-orange-500">Usuario</span>
              </h1>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-7xl space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Nueva Contraseña (Opcional)</label>
                <div className="relative">
                  <input
                    type="password"
