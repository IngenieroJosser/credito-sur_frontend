...
import { formatCOPInputValue, parseCOPInputToNumber } from '@/lib/utils';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  inputMode="numeric"
                  value={formData.monto ? formatCOPInputValue(String(formData.monto)) : ''}
                  onChange={e => setFormData({ ...formData, monto: parseCOPInputToNumber(e.target.value) })}
                  className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all font-medium text-slate-900"
                />
              </div>
            </div>
