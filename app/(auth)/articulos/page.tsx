...
/**
 * ============================================================================
 * ARTÍCULOS / INVENTARIO - PÁGINA UNIFICADA (PERMISSION-BASED)
 * ============================================================================
 * 
 * @description
 * Módulo unificado de gestión de artículos e inventario.
 * Reemplaza las versiones duplicadas por rol:
 * - /admin/articulos (CRUD completo, estadísticas, categorías)
 * - /coordinador/articulos (solo lectura - catálogo de consulta)
 * - /contador/articulos (re-exportaba admin)
 * 
 * @permissions
