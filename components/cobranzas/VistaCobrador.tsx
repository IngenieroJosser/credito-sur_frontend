...
// Componente Sortable para las visitas (se mantiene igual)
...
const VistaCobrador = () => {
      ...
      try {
        ...
        if (userData) {
          ...
          if (user.rol !== 'COBRADOR') {
            console.log('Rol incorrecto, redirigiendo según rol:', user.rol);
          ...
          console.log('No hay datos de usuario en localStorage, obteniendo del backend');
  ...
  // Si no estamos en el cliente o estamos cargando, mostrar un placeholder
