        ...
        {mainMetrics.map((metric, index) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className={`p-2 rounded-lg bg-gradient-to-br ${metric.color === 'var(--primary)' ? 'from-[#08557f]/10 to-[#08557f]/5' : metric.color === 'var(--success)' ? 'from-[#10b981]/10 to-[#10b981]/5' : metric.color === 'var(--danger)' ? 'from-[#ef4444]/10 to-[#ef4444]/5' : 'from-[#fb851b]/10 to-[#fb851b]/5'}`}>
            ...
            <div className="mt-4 h-1 flex items-end space-x-px">
              {metric.trendData.map((value, i) => (
                <div
                  ...
                  style={{
                    height: `${value * 0.6}%`,
                    backgroundColor: metric.color.replace('var(--', '#').replace(')', ''),
